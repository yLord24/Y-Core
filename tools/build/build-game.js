...
--//Variables
${nativeModuleBuild ? `if not LPH_OBFUSCATED then
\tgetfenv()["LPH_NO_VIRTUALIZE"] = function(callback)
\t\treturn callback
\tend
end
` : ""}
...
\tlocal moduleContent = self:Fetch(modulePath)
\tlocal loadedChunk
...
function printSummary() {
	...
	console.log(`[YCore Builder] NativeModules: ${nativeModuleBuild ? "yes" : "no"}`);
